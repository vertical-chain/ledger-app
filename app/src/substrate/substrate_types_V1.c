...
parser_error_t _readBoxRawSolutionSolutionOfMinerConfig_V1(parser_context_t* c, pd_BoxRawSolutionSolutionOfMinerConfig_V1_t* v)
{
    return parser_not_supported;
}
...
parser_error_t _readSpNposElectionsSupportVoter(parser_context_t* c, pd_SpNposElectionsSupportVoter_V1_t* v) {
     CHECK_ERROR(_readAccountId_V1(c, &v->account_id));
     CHECK_ERROR(_readu128(c, &v->extended_balance))
     return parser_ok;
 }

 parser_error_t _readSpNposElectionsSupport(parser_context_t* c, pd_SpNposElectionsSupport_V1_t* v) {
     CHECK_ERROR(_readu128(c, &v->total));

     pd_SpNposElectionsSupportVoter_V1_t dummy; 
     compactInt_t clen;
 ...
 parser_error_t _readVecSupports_V1(parser_context_t* c, pd_VecSupports_V1_t* v) {
     GEN_DEF_READVECTOR(SupportsAccountId_V1)
 }
...
parser_error_t _toStringBoxRawSolutionSolutionOfMinerConfig_V1(
    const pd_BoxRawSolutionSolutionOfMinerConfig_V1_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount)
